...
YouPay is a cryptocurrency payment plugin for e-commerce sites. Published by Youseeme, YouPay is registered as a digital asset service provider (PSAN) with the AMF under number E2022-50.
...
**Note**: **YouPay** by Youseeme only supports **EUR** across all European Economic Area (E.E.A.) countries.
...
You can also sign up on ([Youseeme Crypto](https://user.youseeme.io)) to obtain your free wallet for crypto collection and to obtain your crypto public address or alternatively, you can email us at ([customer support](mailto:support@youseeme.fr)).
...
Follow the steps below to setting up the YouPay plugin
...
== Changelog ==
= 1.2.1 =
* Fix of google chart qr not working anymore
= 1.2.0 =
* Add of Youseeme payment blocks for WooCommerce blocks in gutenberg editor
= 1.1.7 =
* Add of Requires Plugins: woocommerce in main file comments for displaying in plugins librairy
= 1.1.6 =
* Bug fix on qr code regeneration on admin panel
= 1.1.5 =
* Bug fix
= 1.1.4 =
* Security updates
